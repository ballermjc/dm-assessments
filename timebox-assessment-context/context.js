...
//called almostThere. You should bind it to the
//context descent.
...
//a variable called finalDescent. 
...
//Q1:
//Call the method checkOut on book1, and save it to a 
//variable called book1CheckOut.

//CODE HERE
var book1CheckOut = book1.checkOut()

//What is the context of calling book1.checkOut()?
...
//What is the context of calling the function checkOut on book1?
...
//Q3:
//Call the function checkout, and save it to a 
//variable called globalCheckOut.

//CODE HERE
var globalCheckOut = checkOut()

//What is the context of calling checkOut()?
...
//Q4:
//Apply the book1 method checkOut on book2, and save it to a 
//variable called book2CheckOut2.
...
//Q1:
//Use the method .call to call updatePerson on person1;
//pass in the values "Anne Boleyn", 30, and "Queen of 
//England"; save the result to a variable called queenAnne.
var queenAnne = updatePerson.call(person1, "Anne Boleyn", 30, "Queen of England")

//Q2:
//Use the method .apply to call updatePerson on person2;
//pass in the values "Catherine of Aragon", 37, and "Former 
//Queen"; save the result to a variable called queenAnne.
